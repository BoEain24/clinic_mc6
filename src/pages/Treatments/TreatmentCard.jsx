...
const TreatmentCard = ({treatment:{id,image,date,title,description}}) => {
    ...
    <div className='col-span-4 rounded-lg border border-zinc-200 overflow-hidden'>
        ...
        <div className='p-5 h-[310px] flex flex-col gap-y-6 bg-zinc-100 hover:bg-zinc-300 duration-200 transition-all'>
            ...
            <div onClick={() => nav(`/blog/detail/${id}`) } className='py-2 ' >
                    <span className='text-base text-secondary inline-flex items-center gap-2'> Check More <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 fill-secondary">
