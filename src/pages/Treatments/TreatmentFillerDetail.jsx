    ...
    return (
        <div className='px-32 py-16'>
            ...
            <div className='flex justify-center items-center py-14'>
                <img src="../../src/Assets/treatment/4.jpg" className='rounded-lg' alt="" />
                <div>
                <h4 className='font-heading text-heading text-2xl mb-4'>What is Dermal Fillers?</h4>
                <p className='font-satoshi'>Dermal fillers are injectable substances used to add volume, smooth lines, and enhance facial contours. </p>
                <p className='font-satoshi'>Made from materials like hyaluronic acid (a substance naturally found in the body), calcium hydroxylapatite, or poly-L-lactic acid, these fillers are commonly used in aesthetic medicine to reduce signs of aging, restore lost facial volume, and enhance features like the lips, cheeks, and jawline.</p>
                </div>
            </div>
...
export default TreatmentFillerDetail