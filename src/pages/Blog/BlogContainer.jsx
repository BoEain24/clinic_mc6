...
const BlogCotntainer = () => {
  const [blogs, setBlogs] = useState([
        ...
        services: [
          {
            ...
            description: 'HIFU results are not instant; collagen remodeling takes time. You’ll typically notice improvements over 2-3 months, so trust the process and avoid rushing into additional treatments./n/n/nFrom proper skincare routines to post-treatment care, these essentials can enhance the collagen stimulation process and ensure long-lasting benefits. Whether you’re looking to lift sagging skin, reduce fine lines, or achieve a more youthful appearance, these tips are your guide to making the most of your HIFU journey.'
          },
        ],
        faq: [
          {
    ...
    },
    {
        ...
        services: [
          {
            ...
            description: <pre>
              ...
              . Lifestyle habits like poor sleep or dehydration
            </pre>
          }, {
            id: 2,
            ...
            description: <pre>
              ...
              . Reduce Salt Intake: Avoid salty foods to minimize puffiness.
            </pre>
          }, {
            id: 3,
            title: 'Professional Treatments Available in Our Clinic',
            description: <pre>
              . Dermal Fillers: Restore volume under the eyes and reduce shadowing.
              . Laser Therapy: Targets pigmentation and stimulates collagen.
              . Chemical Peels: Lightens hyperpigmentation for brighter under-eye skin.
              . Microneedling: Improves skin texture and encourages collagen production.
            </pre>
          }, {
            id: 4,
            title: 'Topical Treatments',
            description: <pre>
              . Brightening Creams: Look for ingredients like Vitamin C, Kojic Acid, or Niacinamide.
              . Retinol: Boosts collagen to thicken under-eye skin and reduce visibility of veins.
              . Caffeine-Based Products: Reduces puffiness and tightens skin temporarily.
            </pre>
          }, {
            id: 5,
        ...
        faq: [
          {
            ...
            id: 4,
            question: `If topical products and lifestyle changes don't provide noticeable improvement, consult a dermatologist or aesthetic doctor for treatments like dermal fillers, laser therapy, or chemical peels.`,
            isOpen: false
          }
        ...
        services: [
          {
            ...
            title: `Botox:`,
            description: <pre>
              . Purpose: Botox is designed to treat dynamic wrinkles—wrinkles caused by repetitive muscle movements such as smiling, frowning, or squinting.
              . How It Works: Botox works by temporarily relaxing the muscles beneath the skin, which smooths out wrinkles and prevents them from deepening. The treatment targets areas where facial expressions cause lines to form.
              . Common Treatment Areas: Forehead lines, crow’s feet (around the eyes), frown lines (between the eyebrows), and bunny lines on the nose.
              . Duration: Results last 3-6 months, with follow-up treatments required to maintain the effects.
            </pre>
          },
          {
            id: 2,
            ...
            description: <pre>
              . Purpose: Dermal fillers restore volume to areas of the face that have lost fullness due to aging. They also smooth out static wrinkles, which are visible even when the face is at rest.
              . How It Works: Fillers are injected into the skin to add volume, plump sagging areas, and reduce the appearance of deep lines. They can also stimulate collagen production, improving skin texture over time.
              . Common Treatment Areas: Cheeks, lips, nasolabial folds (smile lines), marionette lines (around the mouth), and under-eye hollows.
              . Duration: Results can last 6-18 months, depending on the type of filler used and the treatment area.
            </pre>
          },
          {
            id: 3,
            ...
            description: <pre>
              . Botox is ideal if you are looking to smooth out wrinkles caused by facial expressions and muscle movements.
              . Fillers are the better option for restoring volume and treating static wrinkles that remain even when your face is relaxed.
            </pre>
          },
          {
            id: 4,
        ...
        services: [
          {
            ...
            description: <pre>
              ...
              . Moisturize: Hydrate your skin with a suitable moisturizer to keep it soft and plump.
              . Protect: Apply sunscreen daily to shield your skin from UV damage.
            </pre>
          }, {
            id: 2,
        ...
        services: [
          {
            ...
            description: <ul>
              ...
              <li>Microneedling with PRP (Platelet-Rich Plasma)</li>
              <li>Laser Skin Resurfacing</li>
              <li>Collagen-Stimulating Treatments (HIFU or RF Therapy)</li>
            </ul>
          }
        ],
        faq: [
      ...
      detail: {
        img: 'src/Assets/Blog/understand-acne-scar.jpg',
        ...
        services: [
          {
            ...
            description: <ul>
              <li>Atrophic Scars: The skin doesn’t produce enough collagen during the healing process.</li>
              <li>Hypertrophic Scars: Raised scars caused by excess collagen production.</li>
              <li>Post-inflammatory Hyperpigmentation (PIH): Dark spots left behind after acne heals (not true scars but often mistaken for them).</li>
            </ul>
          }, {
            id: 2,
            ...
            description:
              <pre>
                ...
                How it works: Removes damaged layers of skin and stimulates collagen production.
                Best for: Atrophic scars, especially boxcar and rolling scars.
                2. Microneedling with PRP
                How it works: Tiny needles create controlled micro-injuries to boost collagen production, enhanced with platelet-rich plasma for faster healing.
                Best for: Reducing the depth of scars and improving skin texture.
                3. Chemical Peels
                How it works: Exfoliates the skin deeply to improve discoloration and texture.
                Best for: PIH and mild atrophic scars.
                Dermal Fillers
                How it works: Temporary fillers plump up depressed scars to even out the skin's surface.
                Best for: Ice-pick and boxcar scars.
                Radiofrequency Microneedling
                How it works: Combines microneedling with radiofrequency energy to tighten and improve skin texture.
                Best for: Deeper scars and overall rejuvenation.
                Topical Treatments
                How it works: Retinoids, vitamin C serums, and AHAs improve mild discoloration and texture.
                Best for: Early-stage scars and maintenance.
            ...
            description: `
                Use sunscreen daily to prevent further discoloration.
