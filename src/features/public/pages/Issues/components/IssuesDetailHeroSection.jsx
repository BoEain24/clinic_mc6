        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-5 ">
            <img
              src={moistureImage}
              alt=""
              className="w-[415px] h-[240px] rounded-lg mb-6"
            />
            <img
              src={retenoidsImage}
              alt=""
              className="w-[415px] h-[240px] rounded-lg"
            />
          </div>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="space-y-8 text-base ml-6">
                  ...
                  <div className="">
                    ...
                    <div className="space-y-8 text-base">
                      <p>
                        Quality sleep helps the body repair and regenerate skin
                        cells, while poor sleep can accelerate aging signs.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <ul className="list-disc space-y-4">
                    ...
                    <li>
                      <p>
                        ...
                        Uses heat to boost collagen production and lift sagging
                        skin, providing firmer, youthful-looking skin over time.
                      </p>
                    </li>
                    <li>
                      <p>
                    ...
                    <li>
                      <p>
                        ...
                        Fillers add volume and lift to areas where skin has lost
                        elasticity, giving a more youthful contour.
                      </p>
                    </li>
                  </ul>
                </div>
